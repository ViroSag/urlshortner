...
<main className="bg-purple-100">
 ...
 <p className="px-26 text-center">
  We are the most straightforward and easy to use url shortner in the world. Most of the url shortners will track you or ask your details for login. We understand your needs and hence we created this url shortner which is free and easy to use.
 </p>
